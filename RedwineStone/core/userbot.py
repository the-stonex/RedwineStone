...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER(__name__).info(f"Starting Stone Assistants...")
        if config.STRING1:
            ...
            assistants.append(1)
            try:
                await self.one.send_message(config.LOGGER_ID, "Stone Assistant Started")
            except:
            ...
            LOGGER(__name__).info(f"Stone Assistant Started as {self.one.name}")
        ...
        if config.STRING2:
            ...
            assistants.append(2)
            try:
                await self.two.send_message(config.LOGGER_ID, "Stone Assistant Started")
            except:
                LOGGER(__name__).error(
            ...
            LOGGER(__name__).info(f"Stone Assistant Two Started as {self.two.name}")
        ...
        if config.STRING3:
            ...
            assistants.append(3)
            try:
                await self.three.send_message(config.LOGGER_ID, "Stone Assistant Started")
            except:
                LOGGER(__name__).error(
            ...
            LOGGER(__name__).info(f"Stone Assistant Three Started as {self.three.name}")
        ...
        if config.STRING4:
            ...
            assistants.append(4)
            try:
                await self.four.send_message(config.LOGGER_ID, "Stone Assistant Started")
            except:
                LOGGER(__name__).error(
            ...
            LOGGER(__name__).info(f"Stone Assistant Four Started as {self.four.name}")
        ...
        if config.STRING5:
            ...
            assistants.append(5)
            try:
                await self.five.send_message(config.LOGGER_ID, "Stone Assistant Started")
            except:
                LOGGER(__name__).error(
            ...
            LOGGER(__name__).info(f"Stone Assistant Five Started as {self.five.name}")
