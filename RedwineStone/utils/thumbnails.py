...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("RedwineStone/assets/font2.ttf", 30)
    font = ImageFont.truetype("RedwineStone/assets/font.ttf", 30)
    title_font = ImageFont.truetype("RedwineStone/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("RedwineStone/assets/play_icons.png")
